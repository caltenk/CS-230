...
public abstract class Moveable {
    ...
    /**
     * suggested to allow filehandling -Dan note: filehandling solution for
     * inheritance not tested, does not fully deal with Moveable data.
     */
    public Moveable(String moveableData) {
        ...
        //...
        /**
         * note: need some way to set image. 1 - save/load image file references
         * (limiting but simple). 2 - use a separate method in/called by end
         * subclasses (Player, specific enemy types) (this would allow different
         * images according to the type of Moveable and, for eg a chosen theme
         * in the game).
         */
    }

    /**
     * suggested to allow filehandling -Dan note: if image selection is done by
     * storing image file references, they must be added here.
     *
     * @return
     */
    @Override
