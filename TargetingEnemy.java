...
public abstract class TargetingEnemy extends Enemy {
    ...
    /**
     * saves the targetingEnemy character as a string from which a copy can later be loaded using
     * the targetingEnemy(String) constructor, used to save the targetingEnemy character to a text file.
     *
     * @return a string containing all information needed to load a copy of this targetingEnemy character.
     */
    @Override
