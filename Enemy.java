...
public abstract class Enemy extends Moveable {
    ...
    /**
     * loads an Enemy character from a string as generated by toString(), used to load data
    ...
    /**
     * saves the Enemy character as a string from which a copy can later be loaded using
     * the Enemy(String) constructor, used to save the Enemy character to a text file.
     *
     * @return a string containing all information needed to load a copy of this Enemy character.
     */
