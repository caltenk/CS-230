...
public class StraightLineEnemy extends Enemy {
    ...
    /**
     * This method contructs a straight line enemy
    ...
    /**
     * loads a StraightLineEnemy character from a string,
     * as generated by toString(), used to load data
    ...
    /**
     * saves the StraightLineEnemy character as a string,
     * from which a copy can later be loaded,
     * using the StraightLineEnemy(String) constructor,
     * used to save the StraightLineEnemy character to a text file.
     *
     * @return A string to load a copy of this StraightLineEnemy character.
     */
    @Override
