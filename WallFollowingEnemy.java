...
public class WallFollowingEnemy extends Enemy {
     ...
     * WallFollowingEnemy (including superclass data).
     *
     * @param smartData WallFollowingEnemy data and Enemy data.
     */
    ...
    /**
     * generates a string from which a duplicate WallFollowingEnemy can be 
     * constructed, containing all information about the WallFollowingEnemy
